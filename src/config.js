...
export const APP_HOME = process.env.INFINITE_PRESS_AGENT_HOME || process.env.QWOTED_WORKER_HOME || join(homedir(), ".infinite-press-agent");
...
export const SERVICE_LABEL = process.env.INFINITE_PRESS_AGENT_SERVICE_LABEL || process.env.QWOTED_SERVICE_LABEL || "com.infinite-press-agent.agent";
