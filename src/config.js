...
export const APP_HOME = process.env.QWOTED_WORKER_HOME || join(homedir(), ".qwoted-worker");
...
export const SERVICE_LABEL = process.env.QWOTED_SERVICE_LABEL || "com.qwoted-worker.agent";
